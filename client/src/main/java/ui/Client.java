...
public class Client implements NotificationHandler {
    ...
    private boolean playerIsAvailable(String number, String desiredColor) {
        ...
        return helperFunctions.helperPlayerIsAvailable(this.username, desiredColor, jsonElement);
    }
    ...
    public ChessPosition getValidCoordinates(String command) {
        ...
        return helperFunctions.helperGetValidCoordinates(command, currentBoard);
    }
