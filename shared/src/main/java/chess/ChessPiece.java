...
public class ChessPiece {
    ...
    public ArrayList<ChessMove> bishopMove(ChessBoard board, ChessPosition myPosition){
    ...
    public ArrayList<ChessMove> rookMove(ChessBoard board, ChessPosition myPosition){
        ArrayList<ChessMove> moves = new ArrayList<ChessMove>();
        int row = myPosition.getRow();
        int column = myPosition.getColumn();
        //up
    ...
    public Collection<ChessMove> pieceMoves(ChessBoard board, ChessPosition myPosition) {
        ...
        if (board.getPiece(myPosition).getPieceType() == PieceType.KNIGHT){
            moves.addAll(knightMove(board, myPosition));
        }
        if (board.getPiece(myPosition).getPieceType() == PieceType.KING){
            moves.addAll(kingMove(board, myPosition));
        }
